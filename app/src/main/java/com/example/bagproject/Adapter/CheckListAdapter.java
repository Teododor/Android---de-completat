package com.example.bagproject.Adapter;
...
import com.example.bagproject.CheckList;
...
import com.example.bagproject.R;
    ...
    public void onBindViewHolder(@NonNull CheckListViewHolder holder, int position) {
        ...
        holder.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                database.itemsDao().checkUncheck(itemsList.get(position).getID(), check);
                if (MyConstants.FALSE_STRING.equals(show)) {
                    itemsList = database.itemsDao().getAllSelected(true);
        ...
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton("Cofirm", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                database.itemsDao().delete(itemsList.get(position));
