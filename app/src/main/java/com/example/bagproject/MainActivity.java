package com.example.bagproject;
...
import com.example.bagproject.Adapter.Adapter;
import com.example.bagproject.Constants.MyConstants;
import com.example.bagproject.Data.AppData;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("<---------------------------------------------------------------->" + database.itemsDao().getAllSelected(false).get(0));//.getItemname());
    ...
    private void persistAppData(){
        ...
        if(!prefs.getBoolean(MyConstants.FIRST_TIME_CAMEL_CASE, false)){
            ...
            database.itemsDao().deleteAllSystemItems(MyConstants.SYSTEM_SMALL);
            appData.persistAllData();
